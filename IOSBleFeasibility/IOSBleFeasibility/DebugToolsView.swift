        ...
        DebugCard {
            VStack(alignment: .leading, spacing: 12) {
                ...
                Grid(alignment: .leading, horizontalSpacing: 14, verticalSpacing: 8) {
                    ...
                    debugRow("Display", bleManager.connectionDisplayState)
                    ...
                    debugRow("Suspect count", "\(bleManager.connectionHealthSuspectCount)")
                    debugRow("Stale count", "\(bleManager.connectionHealthStaleCount)")
                    debugRow("Hard reconnect count", "\(bleManager.connectionHealthHardReconnectCount)")
                    debugRow("Max notify gap", "\(bleManager.connectionHealthMaxNotifyGapMs)ms")
